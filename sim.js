...
(function (pxsim) {
    ...
    class DalBoard extends pxsim.CoreBoard {
        constructor(boardDefinition) {
            ...
            this.mhz19bState = new pxsim.MHZ19BState();
            this.ina219State = new pxsim.INA219State();
            this.soilHygrometerState = new pxsim.SoilHygrometerState();
            this.sen0422State = new pxsim.ECMeterSEN0244State();
            this.anemometerState = new pxsim.AnemometerState();
            this.phmeterState = new pxsim.PhmeterState();
            this.dbMeterState = new pxsim.AnalogSensorState(22 /* DEVICE_ID_SYSTEM_LEVEL_DETECTOR_SPL */, 0, 120);
            ...
            this.builtinVisuals["soil_hygrometer"] = () => new pxsim.visuals.SoilHygrometerView();
            this.builtinPartVisuals["soil_hygrometer"] = (xy) => pxsim.visuals.mkSoilHygrometerPart(xy);
            this.builtinParts["mh_z19b"] = this.mhz19bState;
            this.builtinVisuals["mh_z19b"] = () => new pxsim.visuals.MHZ19BView();
            this.builtinPartVisuals["mh_z19b"] = (xy) => pxsim.visuals.mkMHZ19B(xy);
            this.builtinParts["ina219"] = this.ina219State;
            this.builtinVisuals["ina219"] = () => new pxsim.visuals.INA219View();
            this.builtinPartVisuals["ina219"] = (xy) => pxsim.visuals.mkINA219(xy);
            this.builtinParts["ecmeter_sen0244"] = this.sen0422State;
            this.builtinVisuals["ecmeter_sen0244"] = () => new pxsim.visuals.ECMeterSEN0244View();
            this.builtinPartVisuals["ecmeter_sen0244"] = (xy) => pxsim.visuals.mkECMeterSEN0244(xy);
            this.builtinParts["phmeter"] = this.phmeterState;
            this.builtinVisuals["phmeter"] = () => new pxsim.visuals.phmeterView();
            this.builtinPartVisuals["phmeter"] = (xy) => pxsim.visuals.mkphmeter(xy);
            this.builtinParts["anemometer"] = this.anemometerState;
            this.builtinVisuals["anemometer"] = () => new pxsim.visuals.AnemometerView();
            this.builtinPartVisuals["anemometer"] = (xy) => pxsim.visuals.mkAnemometer(xy);
            this.builtinParts["dbmeter"] = new pxsim.DBMeterState(this.dbMeterState);
            this.builtinVisuals["dbmeter"] = () => new pxsim.visuals.DBMeterView();
        }
        kill() {
            super.kill();
    ...
    `;
        ...
        class MetroBoardSvg extends visuals.GenericBoardSvg {
            constructor(props) {
                ...
                this.onBoardDBMeter = new visuals.DBMeterView();
                ...
                this.onBoardDBMeter.init(this.board.bus, new pxsim.DBMeterState(this.board.dbMeterState), el, null);
            }
            updateTheme() {
...
(function (pxsim) {
    ...
    (function (input) {
        let AnemometerUnit;
        (function (AnemometerUnit) {
            AnemometerUnit[AnemometerUnit["RPM"] = 0] = "RPM";
            AnemometerUnit[AnemometerUnit["RPS"] = 1] = "RPS";
        })(AnemometerUnit || (AnemometerUnit = {}));
        async function getAnemometerRotation(pin, timeSpan) {
            return new Promise(async (resolve, reject) => {
                let state = pxsim.anemometerState();
                await new Promise((resolve) => setTimeout(resolve, timeSpan * 1000));
                resolve(state.getRPS());
            });
        }
        input.getAnemometerRotation = getAnemometerRotation;
        async function getAnemometerRotationPerUnit(pin, unit, timeSpan) {
            return new Promise(async (resolve, reject) => {
                let result = await getAnemometerRotation(pin, timeSpan).then((value) => {
                    return value;
                });
                resolve(unit == AnemometerUnit.RPM ? result * 60 : result);
            });
        }
        input.getAnemometerRotationPerUnit = getAnemometerRotationPerUnit;
    })(input = pxsim.input || (pxsim.input = {}));
})(pxsim || (pxsim = {}));
/// <reference path="../../../node_modules/pxt-core/built/pxtsim.d.ts"/>
/// <reference path="../../../built/common-sim.d.ts"/>
...
(function (pxsim) {
    ...
    pxsim.AnemometerState = AnemometerState;
    function anemometerState() {
        return pxsim.board().anemometerState;
    }
    pxsim.anemometerState = anemometerState;
})(pxsim || (pxsim = {}));
/// <reference path="../../../node_modules/pxt-core/built/pxtsim.d.ts"/>
    ...
    (function (visuals) {
        ...
        function mkAnemometer(xy = [0, 0]) {
            ...
            pxsim.svg.hydrate(img, {
                ...
                width: w,
                height: h,
                href: pxsim.svg.toDataUri(ANEMOMETER_PART),
            });
            return { el: img, x: l, y: t, w: w, h: h };
        }
        visuals.mkAnemometer = mkAnemometer;
        class AnemometerView {
            constructor() {
            ...
            initDom() {
                ...
                this.text_value = this.image.getElementById("value");
                this.handle = this.image.getElementById("handle");
                this.ruler = this.image.getElementById("ruler");
            ...
            rotateCups(angle) {
                ...
                transform = transform.replace(`rotate(${this.rotation} 46.302 46.302)`, // absolute position of cups in the svg
                `rotate(${this.rotation + angle} 46.302 46.302)`);
                this.rotation = this.rotation + angle;
                this.element.querySelector("#cups").setAttribute("transform", transform);
            }
            moveToCoord(xy) {
                visuals.translateEl(this.element, [xy[0], 590]);
            }
            updateTheme() { }
            updateState() {
            ...
            moveHandle(event) {
                ...
                let point = this.image.createSVGPoint();
                ...
                this.state.setRPS(Math.round((100 * (-1 * offset)) / this.ruler.height.baseVal.value));
                this.updateState();
            }
        }
        visuals.AnemometerView = AnemometerView;
...
(function (pxsim) {
    var input;
    (function (input) {
        function ondbMeterConditionChanged(condition, value, body) {
            let b = pxsim.dbMeterState();
            b.setUsed();
            if (condition == 2 /* ANALOG_THRESHOLD_HIGH */) {
        ...
        input.ondbMeterConditionChanged = ondbMeterConditionChanged;
        function decibel() {
            let b = pxsim.dbMeterState();
            b.setUsed();
            return b.getLevel();
        }
        input.decibel = decibel;
    })(input = pxsim.input || (pxsim.input = {}));
})(pxsim || (pxsim = {}));
/// <reference path="../../../node_modules/pxt-core/built/pxtsim.d.ts"/>
/// <reference path="../../../built/common-sim.d.ts"/>
...
(function (pxsim) {
    class DBMeterState {
        constructor(dbMeterState) {
            this.dbMeterState = dbMeterState;
        }
    }
    pxsim.DBMeterState = DBMeterState;
    function dbMeterState() {
        return pxsim.board().dbMeterState;
    }
    pxsim.dbMeterState = dbMeterState;
})(pxsim || (pxsim = {}));
/// <reference path="../../../node_modules/pxt-core/built/pxtsim.d.ts"/>
    ...
    (function (visuals) {
        class DBMeterView {
            constructor() {
                this.style = visuals.BUTTON_PAIR_STYLE;
                this.isOpen = false;
                this.INPUT_ID = "DBMETER-RANGE";
                this.ICON_SVG = `<path d="M33 46V22c0-9.35 7.65-17 17-17s17 7.65 17 17v24c0 9.35-7.65 17-17 17s-17-7.65-17-17zm46 0H69c0 10.477-8.523 19-19 19s-19-8.523-19-19H21c0 14.284 10.386 26.183 24 28.56V85H34c-1.65 0-3 1.35-3 3v4c0 1.65 1.35 3 3 3h32c1.65 0 3-1.35 3-3v-4c0-1.65-1.35-3-3-3H55V74.56C68.614 72.183 79 60.284 79 46z"/>`;
                this.dBmin = 0;
                this.dBmax = 120;
            }
            init(bus, state, svgEl, otherParams) {
            ...
            mkDBMeter() {
                ...
                this.slider = document.createElement("input");
                this.board_icon = pxsim.svg.elt("g");
                this.text = pxsim.svg.elt("text", { x: 233, y: 520, "font-family": "monospace", "font-size": 25, fill: "#FFFFFF" });
                this.board_icon.style.cursor = "pointer";
            ...
            updateDecibel() {
                ...
                pxsim.accessibility.setLiveContent(t + "dB");
            }
            generateIcon(width, height, x, y) {
        ...
        visuals.DBMeterView = DBMeterView;
    })(visuals = pxsim.visuals || (pxsim.visuals = {}));
})(pxsim || (pxsim = {}));
var pxsim;
(function (pxsim) {
...
(function (pxsim) {
    let ECUnit;
    (function (ECUnit) {
        ECUnit[ECUnit["S_CM"] = 0] = "S_CM";
        ECUnit[ECUnit["MS_CM"] = 1] = "MS_CM";
        ECUnit[ECUnit["US_CM"] = 2] = "US_CM";
    })(ECUnit = pxsim.ECUnit || (pxsim.ECUnit = {}));
})(pxsim || (pxsim = {}));
(function (pxsim) {
    var input;
    (function (input) {
        function getECValue(pin, unit) {
            let state = pxsim.sen0244State();
            switch (unit) {
                case pxsim.ECUnit.US_CM:
                    return state.value * 1000000;
                case pxsim.ECUnit.MS_CM:
                    return state.value * 1000;
                case pxsim.ECUnit.S_CM:
                default:
                    return state.value;
            }
        }
        input.getECValue = getECValue;
    })(input = pxsim.input || (pxsim.input = {}));
})(pxsim || (pxsim = {}));
var pxsim;
(function (pxsim) {
    class ECMeterSEN0244State {
    }
    pxsim.ECMeterSEN0244State = ECMeterSEN0244State;
    function sen0244State() {
        return pxsim.board().sen0422State;
    }
    pxsim.sen0244State = sen0244State;
})(pxsim || (pxsim = {}));
var pxsim;
(function (pxsim) {
    var visuals;
    (function (visuals) {
        // For the intructions
        function mkECMeterSEN0244(xy = [0, 0]) {
            let [x, y] = xy;
            let l = x;
            let t = y;
            ...
            pxsim.svg.hydrate(img, {
                ...
                href: pxsim.svg.toDataUri(SEN0244_PART)
            });
            return { el: img, x: l, y: t, w: w, h: h };
        }
        visuals.mkECMeterSEN0244 = mkECMeterSEN0244;
        class ECMeterSEN0244View {
            constructor() {
                this.is_handle_selected = false;
            }
            init(bus, state, svgEl, otherParams) {
            ...
            initDom() {
                this.element = pxsim.svg.elt("g");
                this.image = new DOMParser().parseFromString(SEN0244_PART, "image/svg+xml").querySelector("svg");
                pxsim.svg.hydrate(this.image, {
                ...
                this.text_value = this.image.getElementById("value").getElementsByTagName("tspan")[0];
                let unit_elem = this.image.getElementById("unit");
                this.text_unit = this.image.getElementById("unit").getElementsByTagName("tspan")[0];
                // Don't really know why, but the 'text-anchor' is removed during parse/hydrate...
        ...
        visuals.ECMeterSEN0244View = ECMeterSEN0244View;
    ...
    (function (visuals) {
        ...
        class HCSR04View {
            ...
            moveHandle(event) {
                ...
                offset = Math.max(-this.ruler.height.baseVal.value, Math.min(0, offset));
                this.handle.setAttribute("transform", `translate(0 ${offset})`);
                this.state.setDistance(Math.round((2960 * (-1 * offset)) / this.ruler.height.baseVal.value) +
                    40);
                this.updateState();
            }
        }
...
(function (pxsim) {
    var input;
    (function (input) {
        function getINA219Voltage() {
            let state = pxsim.ina219State();
            return Math.round(state.voltage * 100) / 100;
        }
        input.getINA219Voltage = getINA219Voltage;
        function getINA219Current() {
            let state = pxsim.ina219State();
            return Math.round(state.current * 100) / 100;
        }
        input.getINA219Current = getINA219Current;
        function getINA219Power() {
            let state = pxsim.ina219State();
            return state.current * state.voltage;
        }
        input.getINA219Power = getINA219Power;
    })(input = pxsim.input || (pxsim.input = {}));
})(pxsim || (pxsim = {}));
var pxsim;
(function (pxsim) {
    ...
    pxsim.INA219State = INA219State;
    function ina219State() {
        return pxsim.board().ina219State;
    }
    pxsim.ina219State = ina219State;
})(pxsim || (pxsim = {}));
var pxsim;
    ...
    (function (visuals) {
        ...
        function mkINA219(xy = [0, 0]) {
            ...
            pxsim.svg.hydrate(img, {
                ...
                href: pxsim.svg.toDataUri(INA219_PART)
            });
            return { el: img, x: l, y: t, w: w, h: h };
        }
        visuals.mkINA219 = mkINA219;
        class INA219View {
            constructor() {
            ...
            initDom() {
                this.element = pxsim.svg.elt("g");
                this.image = new DOMParser().parseFromString(INA219_PART, "image/svg+xml").querySelector("svg");
                pxsim.svg.hydrate(this.image, {
                    class: "sim-INA219", width: INA219_PART_WIDTH, height: INA219_PART_HEIGHT,
                });
                this.element.appendChild(this.image);
                let text_elem_current = this.image.getElementById("value_A");
                let text_elem_voltage = this.image.getElementById("value_V");
                this.text_value_current = text_elem_current.getElementsByTagName("tspan")[0];
                this.text_value_voltage = text_elem_voltage.getElementsByTagName("tspan")[0];
                this.ruler_current = this.image.getElementById("ruler_A");
                this.ruler_voltage = this.image.getElementById("ruler_V");
                this.handle_current = this.image.getElementById("handle_A");
                this.handle_voltage = this.image.getElementById("handle_V");
                // Don't really know why, but the 'text-anchor' is removed during parse/hydrate...
                ...
                this.handle_current.addEventListener("mousedown", () => {
                    this.handle_selected = 1 /* CURRENT */;
                    this.last_y = 0;
                });
                this.handle_voltage.addEventListener("mousedown", () => {
                    this.handle_selected = 0 /* VOLTAGE */;
                    this.last_y = 0;
                });
                document.addEventListener("mouseup", () => {
                    this.handle_selected = null;
...
(function (pxsim) {
    var input;
    (function (input) {
        function getCO2Concentration(pin) {
            let state = pxsim.mhz19BState();
            return state.value;
        }
        input.getCO2Concentration = getCO2Concentration;
    })(input = pxsim.input || (pxsim.input = {}));
})(pxsim || (pxsim = {}));
var pxsim;
(function (pxsim) {
    ...
    pxsim.MHZ19BState = MHZ19BState;
    function mhz19BState() {
        return pxsim.board().mhz19bState;
    }
    pxsim.mhz19BState = mhz19BState;
})(pxsim || (pxsim = {}));
var pxsim;
    ...
    (function (visuals) {
        ...
        function mkMHZ19B(xy = [0, 0]) {
            ...
            pxsim.svg.hydrate(img, {
                ...
                href: pxsim.svg.toDataUri(MHZ19B_PART)
            });
            return { el: img, x: l, y: t, w: w, h: h };
        }
        visuals.mkMHZ19B = mkMHZ19B;
        class MHZ19BView {
            constructor() {
                this.is_handle_selected = false;
                this.last_y = 0;
            ...
            initDom() {
                this.element = pxsim.svg.elt("g");
                this.image = new DOMParser().parseFromString(MHZ19B_PART, "image/svg+xml").querySelector("svg");
                pxsim.svg.hydrate(this.image, {
...
(function (pxsim) {
    var input;
    (function (input) {
        function getPhmeterPh(pin) {
            let state = pxsim.phmeterState();
            let value = 0;
        ...
        input.getPhmeterPh = getPhmeterPh;
        function calibratePhmeter(pin, offset) {
            let state = pxsim.phmeterState();
            const existingOffset = state.offset_tab.find(([id]) => id === pin.id);
            if (existingOffset) {
        ...
        input.calibratePhmeter = calibratePhmeter;
    })(input = pxsim.input || (pxsim.input = {}));
})(pxsim || (pxsim = {}));
var pxsim;
(function (pxsim) {
    ...
    pxsim.PhmeterState = PhmeterState;
    function phmeterState() {
        return pxsim.board().phmeterState;
    }
    pxsim.phmeterState = phmeterState;
})(pxsim || (pxsim = {}));
var pxsim;
    ...
    (function (visuals) {
        ...
        function mkphmeter(xy = [0, 0]) {
            ...
            pxsim.svg.hydrate(img, {
                ...
                href: pxsim.svg.toDataUri(PHMETER_PART)
            });
            return { el: img, x: l, y: t, w: w, h: h };
        }
        visuals.mkphmeter = mkphmeter;
        class phmeterView {
            constructor() {
            }
            init(bus, state, svgEl, otherParams) {
            ...
            initDom() {
                this.element = pxsim.svg.elt("g");
                this.image = new DOMParser().parseFromString(PHMETER_PART, "image/svg+xml").querySelector("svg");
                pxsim.svg.hydrate(this.image, {
        ...
        phmeterView.INTERVAL_MS = 125;
        phmeterView.STEP_VALUE = 1;
        visuals.phmeterView = phmeterView;
...
(function (pxsim) {
    var input;
    (function (input) {
        function getSoilHumidity(pin) {
            let state = pxsim.soilHygrometerState();
            return state.value;
        }
        input.getSoilHumidity = getSoilHumidity;
    })(input = pxsim.input || (pxsim.input = {}));
})(pxsim || (pxsim = {}));
var pxsim;
(function (pxsim) {
    class SoilHygrometerState {
    }
    pxsim.SoilHygrometerState = SoilHygrometerState;
    function soilHygrometerState() {
        return pxsim.board().soilHygrometerState;
    }
    pxsim.soilHygrometerState = soilHygrometerState;
})(pxsim || (pxsim = {}));
var pxsim;
(function (pxsim) {
    ...
    (function (visuals) {
        // For the intructions
        function mkSoilHygrometerPart(xy = [0, 0]) {
            let [x, y] = xy;
            let l = x;
            let t = y;
            ...
            pxsim.svg.hydrate(img, {
                ...
                href: pxsim.svg.toDataUri(SOIL_HUM_PART)
            });
            return { el: img, x: l, y: t, w: w, h: h };
        }
        visuals.mkSoilHygrometerPart = mkSoilHygrometerPart;
        class SoilHygrometerView {
            constructor() {
            }
            init(bus, state, svgEl, otherParams) {
                this.state = state;
            ...
            initDom() {
                this.element = pxsim.svg.elt("g");
                this.image = new DOMParser().parseFromString(SOIL_HUM_PART, "image/svg+xml").querySelector("svg");
                pxsim.svg.hydrate(this.image, {
        ...
        SoilHygrometerView.INTERVAL_MS = 125;
        SoilHygrometerView.STEP_VALUE = 5;
        visuals.SoilHygrometerView = SoilHygrometerView;
